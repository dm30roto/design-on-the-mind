...
This is the second part of the series of post about how I built this blog. The first post was an overview of static sites and static site generators. In this post I'll give a super high level overview of [Jekyll](https://jekyllrb.com).
